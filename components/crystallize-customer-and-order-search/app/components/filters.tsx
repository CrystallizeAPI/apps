            ...
            <div className="mb-4 flex gap-3">
                <div className="bg-white  flex pl-4 rounded-md shadow-sm overflow-hidden">
                    ...
                    >
                        ...
                        <option value={CustomersWithoutIncompleteData}>with incomplete data</option>
                    </select>
                </div>

                <div
                    className={`flex pl-4${
                        state.customerStatus !== CustomersWithOrders ? ' opacity-25 pointer-events-none	' : ''
                    }`}
                >
                    ...
                    <div className={`bg-white flex ml-2 px-4 rounded-md shadow-sm overflow-hidden`}>
                        <Popover.Root>
                                ...
                                >
                                    <div className="flex flex-col gap-4 min-w-[200px]">
                                        <div className="flex justify-between items-center">
                                            <p className="Text text-sm font-bold text-black">Products</p>
                                        ...
                                        <div className="flex flex-row items-center gap-2">
                                            ...
                                            <label className="Label text-md" htmlFor="filter-products-all">
                                                All
                                            </label>
                                        </div>
                                        ...
                                        {state.products.map((product) => (
                                            <div className="flex flex-row items-center gap-2" key={product.id}>
                                                <Checkbox.Root
                                                    className="CheckboxRoot bg-grey h-6 w-6 text-center items-center justify-center flex rounded-md"
                ...
                <div className="flex flex-row gap-2">
                    ...
                    {state.result.subsets.map((subset) => {
                        return (
                            ...
                            >
                                {subset.title} <strong className="text-xs">({subset.hits})</strong>
                            </button>
                        );
                    })}
                </div>
