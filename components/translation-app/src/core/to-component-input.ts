...
function componentHandler(component: Component) {
    switch (component.type) {
        ...
        case ComponentType.ComponentChoice: {
            ...
            return toComponentInput((component.content as ComponentChoiceContent).selectedComponent);
        }
        case ComponentType.ContentChunk: {
            ...
            const transformedChunks = (component.content as ContentChunkContent).chunks.map((chunk) =>
                chunk.map(toComponentInput),
            );
        ...
        case ComponentType.ParagraphCollection: {
            ...
            const paragraphs =
                (content as ParagraphCollectionContent)?.paragraphs?.map((paragraph: ParagraphContent) => {
...
export function toComponentInput(component: Component): ComponentInput {
    return {
        ...
        [component.type]: componentHandler(component),
    };
}
